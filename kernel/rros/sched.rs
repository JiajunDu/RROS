...
pub static mut RROS_CPU_AFFINITY: cpumask::CpumaskT = cpumask::CpumaskT::cpu_mask_all();
...
pub fn rros_migrate_thread(thread: Arc<SpinLock<RrosThread>>, dst_rq: *mut rros_rq) {
    ...
    // trace_rros_thread_migrate(thread, evl_rq_cpu(dst_rq));
...
fn init_rq(rq: *mut rros_rq, cpu: i32) -> Result<usize> {
    ...
    iattr.affinity = cpumask::CpumaskT::cpumask_of(cpu as u32) as *const _;
